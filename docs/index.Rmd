...
```{r}
source <- "https://raw.githubusercontent.com/FelixZangerl/gsv_data/main/tsgt/handel_offline_vgr"

corona_vgr <- read_csv(source) %>%
  ts_xts()

colnames(corona_vgr) <- c("Handel(WWWI-WIFO)","stationärer Handel (GSV)")
...
```{r}
source <- "https://raw.githubusercontent.com/FelixZangerl/gsv_data/main/tsgt/gastro_vgr"

gastro_vgr <- read_csv(source) %>%
  ts_xts()

colnames(gastro_vgr) <- c("Gastronomie und Beherbergung(WWWI-WIFO)","Gastronomie (GSV)")
