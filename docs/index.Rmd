...
dygraph(handel_offline, group = "keywords")%>%
  dyAxis("x", drawGrid = FALSE)%>%
  dySeries("PC1", label = "Index")%>%
  dyEvent("2021-6-10", "Easing measures - less social distancing", labelLoc = "bottom")%>%
  dyEvent("2021-7-01", "Easing measures - night gastronomy", labelLoc = "bottom")%>%
...
dygraph(elektro, group = "keywords")%>%
  dyAxis("x", drawGrid = FALSE)%>%
  dySeries("PC1", label = "Index")%>%
  dyEvent("2021-6-10", "Easing measures - less social distancing", labelLoc = "bottom")%>%
  dyEvent("2021-7-01", "Easing measures - night gastronomy", labelLoc = "bottom")%>%
...
dygraph(dienstleistung, group = "keywords")%>%
  dyAxis("x", drawGrid = FALSE)%>%
  dySeries("PC1", label = "Index")%>%
  dyEvent("2021-6-10", "Easing measures - less social distancing", labelLoc = "bottom")%>%
  dyEvent("2021-7-01", "Easing measures - night gastronomy", labelLoc = "bottom")%>%
...
dygraph(baumarkt, group = "keywords")%>%
  dyAxis("x", drawGrid = FALSE)%>%
  dySeries("PC1", label = "Index")%>%
  dyEvent("2021-6-10", "Easing measures - less social distancing", labelLoc = "bottom")%>%
  dyEvent("2021-7-01", "Easing measures - night gastronomy", labelLoc = "bottom")%>%
...
dygraph(fitness, group = "keywords")%>%
  dyAxis("x", drawGrid = FALSE)%>%
  dySeries("PC1", label = "Index")%>%
  dyEvent("2021-6-10", "Easing measures - less social distancing", labelLoc = "bottom")%>%
  dyEvent("2021-7-01", "Easing measures - night gastronomy", labelLoc = "bottom")%>%
...
dygraph(bibliotheken, group = "keywords")%>%
  dyAxis("x", drawGrid = FALSE)%>%
  dySeries("PC1", label = "Index")%>%
  dyEvent("2021-6-10", "Easing measures - less social distancing", labelLoc = "bottom")%>%
  dyEvent("2021-7-01", "Easing measures - night gastronomy", labelLoc = "bottom")%>%
...
dygraph(mobilitaet_auto, group = "keywords")%>%
  dyAxis("x", drawGrid = FALSE)%>%
  dySeries("PC1", label = "Index")%>%
  dyEvent("2021-6-10", "Easing measures - less social distancing", labelLoc = "bottom")%>%
  dyEvent("2021-7-01", "Easing measures - night gastronomy", labelLoc = "bottom")%>%
